...
int main() {
  ...
  int random_number = distribution(random_engine); // This is the generated random number
...
std::cout << "You've done it! You guessed the number " << random_number << " in " << counter << " guesses!" << std::endl;
